...
| 10 | Entretien + ajouts au fil de l'eau (`scripts/new-viz.mjs`) — livrable permanent | 🟨 **lot Easter_eggs démarré le 2026-08-22** (décision utilisateur, devant la recette) : Lot 0 déblocages du contrat ([ADR 0014](decisions/0014-source-easter-eggs-dans-le-contrat.md), [0015](decisions/0015-genre-de-parametre-choix.md)) + garde-fou WebGL ([ADR 0016](decisions/0016-frontiere-webgl-gate-statique.md)) + sources rapatriées ; shaders (Lot 1) et suite à venir — [`plans/portage-easter-eggs.md`](plans/portage-easter-eggs.md) |
